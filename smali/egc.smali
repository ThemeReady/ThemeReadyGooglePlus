...
.method static constructor <clinit>()V
    ...
    sput-object v0, Legc;->c:Landroid/content/ComponentName;
...
.method public static a(Landroid/content/Context;Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)Lcom/google/android/gms/auth/TokenData;
    ...
    invoke-direct {v1, p1, p2, v0}, Legd;-><init>(Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)V
...
.method static a(Landroid/content/Context;Landroid/content/ComponentName;Legg;)Ljava/lang/Object;
    .locals 5
    ...
    invoke-static {p0}, Lenn;->a(Landroid/content/Context;)Lenn;

    move-result-object v2

    const-string v0, "GoogleAuthUtil"

    invoke-virtual {v2, p1, v1, v0}, Lenn;->a(Landroid/content/ComponentName;Landroid/content/ServiceConnection;Ljava/lang/String;)Z
    ...
    :try_start_0
    invoke-virtual {v1}, Leox;->a()Landroid/os/IBinder;

    move-result-object v0

    invoke-interface {p2, v0}, Legg;->a(Landroid/os/IBinder;)Ljava/lang/Object;
    :try_end_0
    ...
    invoke-virtual {v2, p1, v1, v3}, Lenn;->b(Landroid/content/ComponentName;Landroid/content/ServiceConnection;Ljava/lang/String;)V
...
.method static a(Landroid/content/Context;)V
    ...
    invoke-static {v0}, Lejj;->c(Landroid/content/Context;)V
    :try_end_0
    ...
    iget-object v0, v0, Lejm;->b:Landroid/content/Intent;

    invoke-direct {v4, v0}, Landroid/content/Intent;-><init>(Landroid/content/Intent;)V

    .line 10
    invoke-direct {v1, v2, v3, v4}, Legh;-><init>(ILjava/lang/String;Landroid/content/Intent;)V
    ...
    invoke-virtual {v0}, Lejf;->getMessage()Ljava/lang/String;

    move-result-object v0

    invoke-direct {v1, v0}, Lega;-><init>(Ljava/lang/String;)V
...
.method public static c(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/String;
    ...
    .line 2
    invoke-static {p0, v0, p2, p3}, Legc;->a(Landroid/content/Context;Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)Lcom/google/android/gms/auth/TokenData;
...
.method static d(Landroid/content/Context;Ljava/lang/String;)[Landroid/accounts/Account;
    ...
    .line 5
    invoke-static {p0}, Leje;->b(Landroid/content/Context;)V
