...
# instance fields
.field private synthetic b:Lbyz;


# direct methods
.method constructor <init>(Lbyz;Lel;)V
    .locals 0

    .prologue
    .line 1
    iput-object p1, p0, Lbza;->b:Lbyz;
...
.method protected final synthetic a(Landroid/app/Activity;)Ljava/lang/Object;
    ...
    iget-object v2, p0, Lbza;->b:Lbyz;

    invoke-direct {v1, v2}, Lptz;-><init>(Lel;)V

    .line 6
    invoke-interface {v0, v1}, Lbzc;->o(Lptz;)Lbzk;
